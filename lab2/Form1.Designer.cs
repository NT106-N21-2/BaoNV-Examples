namespace lab2
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			button4.TabIndex = 3;
			button4.Text = "Binary Formatter";
			button4.UseVisualStyleBackColor = true;
			button4.Click += button4_Click;
			// 
			// button5
			// 
			button5.Location = new Point(130, 41);
			button5.Name = "button5";
			button5.Size = new Size(112, 23);
			button5.TabIndex = 3;
			button5.Text = "Binary Formatter";
